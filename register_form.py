...
from wtforms.validators import DataRequired, Email, length as length_valid

class RegisterForm(FlaskForm):
    email = EmailField("Email", validators=[Email("Неправильный email")], render_kw={"required": True})
